...
import com.quran.surah_yasin.data.model.Surah
...
import com.quran.surah_yasin.databinding.ActivitySurahBinding
import com.quran.surah_yasin.extension.common.clazz
import com.quran.surah_yasin.extension.context.getColorCompat
import com.quran.surah_yasin.extension.context.readJsonAssetToString
...
import com.quran.surah_yasin.view.adapter.SurahAdapter
...
class SurahActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        surah = com.quran.surah_yasin.data.model.surah.SurahFactory.generate(SurahQuran.valueOf(surahName))
    ...
    private fun setSurahView() = with(binding) {
        ...
        rvSurah.also {
            val surahModel = com.quran.surah_yasin.data.model.surah.SurahFactory.generate(SurahQuran.valueOf(surahName))
